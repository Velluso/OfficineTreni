...
public class HomeController {
	...
	public @ResponseBody String buildAJAXRequest(
			...
			/*List<String> authorities = (List<String>) httpsession.getAttribute("authorities");
	...
	/*@RequestMapping(value = "/user/viewVagoni", method = RequestMethod.POST)
	public String viewVagoni( @RequestParam("idTreno") String id) {
		return "viewVagoni";
	}*/
}
