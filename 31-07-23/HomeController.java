...
public class HomeController {
	...
	public @ResponseBody String buildAJAXRequest(
	            ...
	            @RequestParam("nomeTreno") String nomeTreno, HttpSession session) {
				...
				try {
						...
						o.setUsername(session.getAttribute("username").toString());
	...
	public @ResponseBody String ordiniAJAXRequest(HttpSession session) {
	        ...
	        if (authorities != null && (authorities.contains("ADMIN"))){
	        	...
	        	System.out.println("Cerco ordini di user:  " + user);
	        	o=or.find(user);
	...
	public @ResponseBody String vagoniAJAXRequest(HttpSession session) {
			...
			VagoneService vs = new VagoneService();
			
				int id = Integer.parseInt(session.getAttribute("idCercato").toString());
			
				System.out.println("Cerco vagoni di treno: " + id);
	        	v = vs.findByTrenoId(id);
	        		
	        	System.out.println(v.size());
	        	
	        	/*for(Vagone vi : v) {
	        		System.out.println(vi.getId());
	        		System.out.println(vi.getIdTreno());
	        		System.out.println(vi.getCompagnia());
	        		System.out.println(vi.getPosizione());
	        		System.out.println(vi.getTipoVagone());
				}*/
